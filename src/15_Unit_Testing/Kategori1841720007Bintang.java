...
public class Kategori1841720007Bintang {
    ...
    public ArrayList<Kategori1841720007Bintang> getByNamaAndKeteranganBintang(String nama, String keterangan) {
        ArrayList<Kategori1841720007Bintang> ListKategori = new ArrayList();
        ResultSet rs;
        if ((nama.trim().length() > 0) && (keterangan.trim().length() > 0)) {
            ...
            rs = DBHelper1841720007Bintang.selectQueryBintang("SELECT * FROM kategori WHERE nama = '" + nama + "'");
        } else {
            rs = DBHelper1841720007Bintang.selectQueryBintang(
                    "SELECT * FROM kategori "
    ...
    public void saveBintang() {
        if (getByIdBintang(mIdkategori).getIdkategoriBintang() == 0) {
            ...
            DBHelper18417200Bintang.executeQueryBintang(SQL);
        }
    }

...
public class FormKoneksi1841720007Bintang extends javax.swing.JFrame 
{
    private static Connection sKoneksi;
    private DefaultTableModel mModel;

    public FormKoneksi1841720007Bintang() 
    {
        initComponents();
        ...
        ambilDataTabelBintang();
    }

    private static void bukaKoneksiBintang() 
    {
        if (sKoneksi == null) 
        {
            try 
    ...
    private void ambilDataTabelBintang() 
    {
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKoneksi1841720007Bintang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            public void run() 
            {
                new FormKoneksi1841720007Bintang().setVisible(true);
            }
        });
    }
